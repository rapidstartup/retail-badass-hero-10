      ...
      if (id) {
        result = await supabase
          ...
          .update({
            ...
            tab_auto_close_policy: requestData.tabAutoClosePolicy,
            tab_customer_eligibility: requestData.tabCustomerEligibility,
            tab_notifications: requestData.tabNotifications,
