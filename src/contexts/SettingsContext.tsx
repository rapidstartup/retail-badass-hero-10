      ...
      try {
        ...
        if (error) {
          ...
          const dbSettings: POSSettings = {
            ...
            tabAutoClosePolicy: data.tab_auto_close_policy || defaultSettings.tabAutoClosePolicy,
            tabCustomerEligibility: data.tab_customer_eligibility || defaultSettings.tabCustomerEligibility,
